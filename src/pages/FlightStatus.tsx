  ...
  return (
    <div className="min-h-screen bg-dark text-white overflow-x-hidden">
      ...
      <section className="pt-32 pb-8 relative">
        <div className="absolute inset-0 bg-radial-gradient from-red/10 via-transparent to-transparent z-0"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold font-space mb-4 animate-fade-in">
              Flight <span className="text-red animate-text-glow">Status</span>
            </h1>
